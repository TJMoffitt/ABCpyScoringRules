...
class TransformTests(unittest.TestCase):    #ABCpyScoringRules_Test
...
class InverseTests(unittest.TestCase): #ABCpyScoringRules_Test
...
class GradPdfTests(unittest.TestCase): #ABCpyScoringRules_Test
