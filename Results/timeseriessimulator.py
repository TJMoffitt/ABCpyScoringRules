...
journal = sampler.sample([y_obs], 300, 100, 300, step_size=0.0001, w_val = 50, path_to_save_journal="tmp.jnl")
end = time.time()
print(np.mean(y_obs))
print(np.std(y_obs))
print("Run Time:" + str(end - start))
journal.plot_posterior_distr(path_to_save="TimeSeries6Simulation.png")
journal.traceplot()
